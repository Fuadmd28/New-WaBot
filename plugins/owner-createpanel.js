// ubah egg dan location ada di config.js,untuk tambahan penyimpanan yang bingung cara nambahin nya chat aja gw di WhatsApp
...
let handler = async (m, {
    ...
    const webPage = "YOUR WEBPAGE" // Web Page
